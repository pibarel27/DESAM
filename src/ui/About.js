                           ...
                           <div className="col-md-9">
                              <div className="member-info">
                                 ...
                                 <div className="social">
                                    <Link to="https://www.instagram.com/somorjit_luwang/" style={socialLinkStyle}><i className="bi bi-instagram"></i></Link>
                                    <Link to="https://www.facebook.com/somorjit.luwang.52" style={socialLinkStyle}><i className="bi bi-facebook"></i></Link>
                                 </div>
                              </div>
                           </div>
                        </div>
