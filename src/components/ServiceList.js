      ...
      <section id="services-list" className="services-list">
        <div className="container" data-aos="fade-up">
          <div className="section-header">
            <h2>What we do? </h2>
            <p>
            We further enhance the academic experience as you are able to build on critical thinking skills, problem-solving, and leadership development that are developed in the classroom in a real-world setting.{" "}
            </p>
          </div>
